class PomodoroTimer {
    constructor() {
        ...
        this.artToggle = document.getElementById('art-toggle');
        this.isArtMode = localStorage.getItem('artMode') === 'true';

        // Initialize theme and art mode
        this.isDarkMode = localStorage.getItem('darkMode') === 'true';
        this.updateTheme();
        this.updateArtMode();
    ...
    initializeEventListeners() {
        ...
        this.artToggle.addEventListener('click', () => this.toggleArt());
    ...
    toggleTheme() {
        if (!this.isArtMode) {  // Only toggle theme if not in art mode
    ...
    updateTheme() {
        if (!this.isArtMode) {  // Only update theme if not in art mode
    ...
    updateArtMode() {
        if (this.isArtMode) {
            document.body.setAttribute('data-art', 'thiebaud');
            document.documentElement.removeAttribute('data-theme');  // Remove any theme
        } else {
            document.body.removeAttribute('data-art');
            this.updateTheme();  // Restore the theme
        }
    }
    ...
    toggleArt() {
        this.isArtMode = !this.isArtMode;
        localStorage.setItem('artMode', this.isArtMode);
        this.updateArtMode();
    }
}
